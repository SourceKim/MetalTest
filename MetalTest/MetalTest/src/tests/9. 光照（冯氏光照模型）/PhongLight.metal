...
PhongLightFragmentShader(
                         ...
                         constant float3 *originColor [[ buffer(0) ]],
                         constant bool *needLight [[ buffer(1) ]],
                         constant float3 *lightColor [[ buffer(2) ]],
                         constant float *ambientStrength [[ buffer(3) ]],
                         constant float3 *lightPos [[ buffer(4) ]],
                         constant float3 *eyePos [[ buffer(5) ]],
                         constant float *specularStrength [[ buffer(6) ]]
                         ) {
